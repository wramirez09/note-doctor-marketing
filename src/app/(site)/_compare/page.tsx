...
// const TITLE = "Compare NoteDoctorAI";
// const DESCRIPTION =
//   "How NoteDoctorAI compares to Cohere Health, Anterior, and Availity AuthPal for prior authorization. Researched 8-row matrices showing why providers pick NoteDoctorAI — transparent pricing, same-day onboarding, and pre-submission screening that stops denials at the source.";
// 
...
//             NoteDoctorAI alternatives, side by side.
//           </h1>
...
//             with sourced claims and a &ldquo;where NoteDoctorAI wins&rdquo;
//             section that summarizes why providers pick us.
//           </p>
...
//               sales@NoteDoctorAI
//             </a>{" "}
//             and we&apos;ll write the comparison page — a researched matrix
//             ending with a clear &ldquo;where NoteDoctorAI wins&rdquo; section,
//             so providers can see exactly why we&apos;re the right pick for the
//             submission side of the workflow.
//           </p>
//           <Link
