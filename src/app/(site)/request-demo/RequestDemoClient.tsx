...
// Lead-capture endpoint resolution:
// 1. NEXT_PUBLIC_LEAD_ENDPOINT (set in Cloudflare Pages env vars) — preferred,
//    used as soon as it's configured (Loops, Resend, HubSpot, internal API, etc.).
// 2. Fallback: the same formsubmit.co address the legacy forms post to. This
//    ensures form submissions never silently fail; the upgrade to a real
