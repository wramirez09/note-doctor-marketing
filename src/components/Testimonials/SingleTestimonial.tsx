...
const SingleTestimonial = ({ testimonial, showStars = false }: { testimonial: Testimonial, showStars?: boolean }) => {
  ...
  return (
    <div className="">
      <div
        className="rounded-xl bg-white px-4 py-[30px] dark:bg-dark sm:px-[30px] min-h-[206px] shadow-md hover:shadow-lg"
        data-wow-delay=".1s"
      >
