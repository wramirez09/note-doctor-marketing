const steps = [
  {
    ...
    body: "NoteDoctorAi reads payer policies in real time and surfaces exactly what clinical documentation is needed — before you submit. No more back-and-forth.",
  },
  {
    num: "02",
  ...
  },
  {
    ...
    body: "By automating documentation checks and reducing rework, NoteDoctorAi gives physicians hours back each week — and patients move faster.",
  },
];
  ...
  return (
    <div className="rounded-xl overflow-hidden border" style={{ background: "rgba(0,0,0,0.4)", borderColor: "var(--border)" }}>
      <div className="flex items-center gap-1.5 px-3.5 py-2.5 border-b" style={{ background: "rgba(255,255,255,0.03)", borderColor: "var(--border)" }}>
        ...
        <span className="ml-2 text-[12px]" style={{ color: "var(--faint)" }}>NoteDoctorAi — Auth Screening</span>
      </div>
