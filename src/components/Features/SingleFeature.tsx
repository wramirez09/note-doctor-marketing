    ...
    <div className="mx-auto w-full px-5 md:w-1/3  lg:w-1/3">
      <div className="wow fadeInUp group mb-12" data-wow-delay=".15s">
        <div className="relative z-10 mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-2xl bg-gray-200">
          <span className="absolute  left-0 top-0 z-[-1] mb-8 flex h-[70px] w-[70px] rotate-[25deg] items-center justify-center rounded-2xl bg-gray-200 bg-opacity-20 duration-300 group-hover:rotate-45"></span>
          <feature.icon
